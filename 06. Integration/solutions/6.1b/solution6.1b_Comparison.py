...
# Data Range 
N = np.arange(1000, 100000, 10000) # Number of intervals for the integration
...
epsilon_MidPoint = intf - MidPoint_data 
epsilon_trapRule = intf - trapRule_data 
epsilon_Simpson = intf - Simpson_data 
