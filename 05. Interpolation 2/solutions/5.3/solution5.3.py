...
Solution 5.3
Needs the piecewiseHermiteInterpolation module
'''

import numpy as np
import matplotlib.pyplot as plt
from piecewiseHermiteInterpolation import *
...
data_x, data_H3, fx = pwHI(f, x_min, x_max, m, n)
...
plt.plot(data_x, data_H3, label = "H3(x)")
